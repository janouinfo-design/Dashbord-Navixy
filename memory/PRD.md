...
- [x] **Restyling L3/L4 selon maquette utilisateur** (2026-06, iteration_26: 100%):
  ...
  - Cartes energie alignees sur le ZOOM maquette user (2026-06): icones NUES sans pastille — Droplet gris (conso thermique), Plug gris (conso electrique), BatteryFull vert (SOC), Wifi gris (couverture) ; seule 'EV batterie faible' garde une pastille CARREE arrondie rouge clair avec BatteryCharging rouge (iconWrap='red-square' dans EnergyCard). Verifie par capture DEMO EV
